...
/// <summary>
/// Thème visuel POSTEK : couleurs, police, sons, logo.
/// Surchargable par le revendeur sans recompilation (themes/postek.json).
/// </summary>
public sealed class Theme
{
    ...
    // Impression (revendeur) — ticket 80 mm ESC/POS.
    ...
    {
        var chemin = Path.Combine(dossierThemes, "postek.json");
