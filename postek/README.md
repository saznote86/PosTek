...
> le **noyau métier exécutable** (licence, fiscal, moteur de migration) et
> leurs **tests**. L'application graphique complète est prévue en Option C
> (.NET/WPF) ou A (PySide6) — voir `docs/CAHIER_DES_CHARGES.md` §4.
...
└── tests/                         # 20 tests unitaires (unittest)
```
